...
class ImageAssets {
  ...
  static const String applogoImg = "$IMAGE_PATH/appLogo.png";
  static const String demoUserImage = "$IMAGE_PATH/demoUserImage.png";
  //Svg icons

  // static const String applogo = "$ICON_PATH/appLogo.svg";

  // static const String applogoImg = "$IMAGE_PATH/facebook.png";
